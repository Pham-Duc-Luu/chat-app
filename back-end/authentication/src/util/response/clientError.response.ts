...
export class ForbiddenResponse<T = undefined> extends ClientErrorResponse<T> {
  constructor(data?: T) {
    super("Forbidden", 403, data);
  }
}

export class NotFoundResponse<T = undefined> extends ClientErrorResponse<T> {
  constructor(data?: T) {
    super("Not Found", 404, data);
  }
}

export class MethodNotAllowedResponse<
  T = undefined
> extends ClientErrorResponse<T> {
  constructor(data?: T) {
...
export class ConflictResponse<T = undefined> extends ClientErrorResponse<T> {
  constructor(data?: T) {
    super("Conflict", 409, data);
  }
}

export class GoneResponse<T = undefined> extends ClientErrorResponse<T> {
  constructor(data?: T) {
    super("Gone", 410, data);
  }
}

export class LengthRequiredResponse<
  T = undefined
> extends ClientErrorResponse<T> {
  constructor(data?: T) {
...
export class URITooLongResponse<T = undefined> extends ClientErrorResponse<T> {
  constructor(data?: T) {
...
export class ImATeapotResponse<T = undefined> extends ClientErrorResponse<T> {
  constructor(data?: T) {
...
export class LockedResponse<T = undefined> extends ClientErrorResponse<T> {
  constructor(data?: T) {
    super("Locked", 423, data);
  }
}

export class FailedDependencyResponse<
  T = undefined
> extends ClientErrorResponse<T> {
  constructor(data?: T) {
...
export class TooEarlyResponse<T = undefined> extends ClientErrorResponse<T> {
  constructor(data?: T) {
    super("Too Early", 425, data);
  }
}

export class UpgradeRequiredResponse<
  T = undefined
> extends ClientErrorResponse<T> {
  constructor(data?: T) {
