 ...
 */
export default function RoundShineBorder({
  borderRadius = 50, // Default to 50 for a circular border
  ...
  return (
    <div
      style={
        {
          '--border-radius': `${borderRadius}%`, // Use percentage for circular shape
        } as React.CSSProperties
      }
      className={cn(
        'relative grid place-items-center rounded-[--border-radius] p-3 text-black',
        className
      )}>
      <div
        style={
